...
public class RestaurantController {
    ...
    /**
     *
     * @return List of all the restaurants in the database
     *
     */
    @RequestMapping(method = RequestMethod.GET, path = "/restaurant", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<RestaurantListResponse> getAllRestaurants() {

        // Getting the list of all restaurants with the help of the restaurant business service
        final List<RestaurantEntity> allRestaurants = restaurantBusinessService.getAllRestaurants();

        RestaurantListResponse restaurantListResponse = new RestaurantListResponse();

        // Adding the list of restaurants to the RestaurantList
        ...
        for (RestaurantEntity n: allRestaurants) {
            ...
            // Getting the address of the restaurant from  the address entity
            ...
            // Getting the state for the current address from the state entity
            ...
            // Setting the address with the state into the restaurant obj
            detail.setAddress(responseAddress);

            // Looping the categories and setting name values 
            ...
            // Joining the List items as a string
            detail.setCategories(String.join(",", categoryLists));

            // Adding category detail to details(RestaurantList)
     ...
     * @return List of all the restaurants matched with given restaurant name
